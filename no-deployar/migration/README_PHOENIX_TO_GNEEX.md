...
| `salesOrder`, `prNumber` | Opcionales en la raíz del movimiento: para `VENTA_DIRECTA` y `EXPEDICION_STOCK` la app valida `SO` / `PR` (`SO`/`PR` + 4–6 dígitos). Siguen viajando en respaldos JSON como el resto de metadatos del movimiento. |
