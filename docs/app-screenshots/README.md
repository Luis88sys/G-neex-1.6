...
Si cambia el diseño de la interfaz, vuelva a ejecutar el script y actualice manuales/presentaciones que enlazan estos archivos (rutas relativas `docs/app-screenshots/…`).
