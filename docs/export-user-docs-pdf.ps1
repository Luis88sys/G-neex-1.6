...
# Uso: desde la raíz del repo:  powershell -NoProfile -ExecutionPolicy Bypass -File docs\export-user-docs-pdf.ps1
...
$pairs = @(
    @{ Html = "User Manual\MANUAL_DE_USUARIO.html"; Pdf = "User Manual\MANUAL_DE_USUARIO.pdf" }
    @{ Html = "User Manual\USER_MANUAL.html";      Pdf = "User Manual\USER_MANUAL.pdf" }
    @{ Html = "User Manual\MANUEL_UTILISATEUR.html"; Pdf = "User Manual\MANUEL_UTILISATEUR.pdf" }
    @{ Html = "Presentation\PRESENTACION_GNEEX.html"; Pdf = "Presentation\PRESENTACION_GNEEX.pdf" }
    @{ Html = "Presentation\PRESENTATION_GNEEX.html"; Pdf = "Presentation\PRESENTATION_GNEEX.pdf" }
    @{ Html = "Presentation\PRESENTATION_GNEEX_FR.html"; Pdf = "Presentation\PRESENTATION_GNEEX_FR.pdf" }
)
