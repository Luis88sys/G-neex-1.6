...
const TransportManager = {
  ...
  _buildTransportCargoDataset(t) {
    ...
    const maxPackages = rows.reduce((m, r) => Math.max(m, Array.isArray(r?.dims) ? r.dims.length : 0), 0);
    const headers = [
      I18n.t("reception.project"),
      I18n.t("transport.truckLabel"),
      I18n.t("table.description"),
      I18n.t("transport.qty"),
      I18n.t("transport.dimsLwh"),
      I18n.t("transport.dimUnit")
    ];
    ...
    const data = rows.map(r => {
      const o = {
        ...
        [I18n.t("transport.truckLabel")]: r.truck,
        [I18n.t("table.description")]: r.material,
        [I18n.t("transport.qty")]: r.quantity,
        [I18n.t("transport.dimsLwh")]: r.dimensions,
        [I18n.t("transport.dimUnit")]: r.unit
      };
