...
const App = {
  ...
  switchTab(tab) {
    if (
      ...
      (tab === "reminders" || tab === "orderlines") &&
      !Auth.hasPerm("movements")
    ) {
      tab = "dashboard";
    }
  ...
  // Confirmaciones
  // =========================================================
  /** Mueve el modal al final del body para ganar en orden de apilamiento (stacking) frente a otros overlays. */
